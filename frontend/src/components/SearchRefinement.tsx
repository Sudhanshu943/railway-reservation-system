...
export default function SearchRefinement() {
  ...
  const handleSearch = (e: React.FormEvent) => {
    ...
    router.push(`/results?${newSearchParams.toString()}`);
  };

  return (
    <div className="bg-surface border border-outline-variant p-[var(--spacing-stack-lg)] 3xl:p-10 rounded-xl shadow-sm m-[var(--spacing-stack-lg)] 3xl:mx-auto 3xl:my-8 mx-auto max-w-[var(--spacing-container-max-width)] 3xl:max-w-[1600px]">
...
function InputWrap({
  ...
  return (
    <div className="relative">
      <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none text-outline">
        {icon}
      </span>
      {children}
    </div>
