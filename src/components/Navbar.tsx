      ...
      <div className="max-w-[var(--spacing-container-max-width)] 3xl:max-w-[1600px] px-[var(--spacing-gutter)] 3xl:px-12 flex justify-between items-center h-16 3xl:h-20 mx-auto w-full">
        ...
        <div className="flex items-center gap-[var(--spacing-stack-md)] 3xl:gap-6">
          <button
            ...
            className="text-label-md 3xl:text-base font-medium text-on-surface-variant hover:text-primary transition-all bg-none border-none cursor-pointer"
          >
            Login
          </button>
          <button
            onClick={openSignupModal}
            className="bg-primary text-on-primary px-[var(--spacing-stack-md)] 3xl:px-6 py-2 3xl:py-3 rounded text-label-md 3xl:text-base font-medium hover:opacity-90 active:scale-95 transition-all cursor-pointer border-none"
          >
            Sign Up
          </button>
        </div>
