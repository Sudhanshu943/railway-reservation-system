...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background px-4 py-8">
      <div className="w-full max-w-[440px] flex flex-col gap-[var(--spacing-stack-lg)]">
        {/* Welcome Section */}
        ...
        {/* Login Card */}
        <section className="bg-surface-container-lowest border border-outline-variant p-[var(--spacing-stack-lg)] rounded-lg shadow-sm">
